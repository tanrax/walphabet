...
a = Analysis(
    ...
    ('bin/windows/libgcc_s_seh-1.dll', 'bin/windows/libgcc_s_seh-1.dll'),
    ('bin/windows/libstdc++-6.dll', 'bin/windows/libstdc++-6.dll'),
    ('bin/windows/libwinpthread-1.dll', 'bin/windows/libwinpthread-1.dll'),
    ],
